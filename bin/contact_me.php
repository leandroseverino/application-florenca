...
$email_body = "Você recebeu uma nova mensagem do form de contato do website da Imobiliaria Florença.<br />"."Aqui estão os Detalhes:<br />Remetente: $name<br />Telefone: $phone<br />E-mail: $email_address<br />Mensagem:<br />$message";
